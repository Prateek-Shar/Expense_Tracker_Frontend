    ...
    <div className="w-full flex">
      ...
      <div className="w-[57%] flex flex-row-reverse">
          <div className="border-[#0077b6] w-[21%] rounded-[20px] flex items-center justify-center border-2 m-1">
              <h1 className="font-semibold text-[24px] text-[#64748B] p-3 w-[100%] bg-linear-to-r from-[#48cae4] to-[#90e0ef] flex items-center rounded-[19px] justify-center">Expense Tracker</h1>
          </div>
      </div>
      ...
      <div className="w-[43%] flex flex-row-reverse items-center">
        ...
        <div className="w-[20%] flex bg-red-600 mr-10 rounded-4xl hover:cursor-pointer p-3" onClick={handleClickToLogout}>
